...
Router::route('/location/([0-9]+)(|/[0-9]+)/category/([0-9]+)', function($state_id, $town_id, $category_id) use($controller){

	// if ($page != null)
	// 	$page = str_replace('/', '', $page);

	if ($town_id != null)
		$town_id = str_replace('/', '', $town_id);
	
	$controller -> locationPage($state_id, $town_id, $category_id, null);

});

Router::route('/location/([0-9]+)(|/[0-9]+)/category/([0-9]+)/page/([0-9]+)', function($state_id, $town_id, $category_id, $page) use($controller){
	...
	$controller -> locationPage($state_id, $town_id, $category_id, $page);

});

// location 
Router::route('/location/([0-9]+)(|/[0-9]+)/page/([0-9]+)', function($state_id, $town_id, $page) use($controller){
	...
	$controller -> locationPage($state_id, $town_id, null, $page);
