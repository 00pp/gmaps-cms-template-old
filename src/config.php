...
define('DB_NAME','bussola');
define('DB_USER','root');
define('DB_PASS','qweasdzxc');
...
define('MAX_COMMENTS_PER_PAGE', 300);
/*
...
define('PUBLISH_ONE_COMMENT_EACH_DAYS', 5); 
/*	
...
*/
define('FIRST_ITEM_DATE', '2020-07-27'); 
// define('MINIMUM_COMMENTS_FIRST_ITEMS', 100);

define('RECAPTCHA_SITE_KEY', '45yhygb'); 
define('RECAPTCHA_SECRET', '6hyju8'); 
